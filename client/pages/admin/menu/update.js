...
export default function UpdateMenu() {
    ...
    useEffect(() => {
        const fetchMenu = async () => {
            ...
            try {
                ...
                const res = await axios.get(${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5002'}/api/menu');
                ...
                if (currentMeals.length === 0) {
                    const mealsRes = await axios.get(${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5002'}/api/meals');
    ...
    const fetchMeals = async () => {
        try {
            const res = await axios.get(${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5002'}/api/meals');
            ...
            new Promise(async (resolve, reject) => {
                try {
                    ...
                    const promises = weekDates.map(dateObj => {
                        ...
                        return axios.post(${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5002'}/api/menu', {
